...
const StatCard = ({ icon, iconBg, value, label }) => (
  <div className="bg-[#FDFAF5] rounded-2xl border border-[rgba(168,137,108,0.15)] shadow-sm p-3.5">
    ...
    <div className="text-[22px] font-semibold text-[#5A5550] leading-none" style={{ fontFamily: 'Fredoka, sans-serif' }}>{value}</div>
    <div className="text-[10px] text-[#8A847C] font-semibold mt-1">{label}</div>
  </div>
);
...
const StatsPage = () => {
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-background)' }}>
      {/* Header */}
      <div className="px-5 pt-6 pb-6 rounded-b-[28px] mb-4" style={{ background: `linear-gradient(160deg, var(--color-primary-pale), var(--color-background))` }}>
        <h1 className="text-[22px] font-semibold text-[#5A5550] mb-1" style={{ fontFamily: 'Fredoka, sans-serif' }}>Tus Estadísticas</h1>
        <p className="text-xs text-[#8A847C]">Semana del 12–18 mayo · Buen trabajo!</p>
      </div>
      ...
      <div className="px-4 pb-24">
        ...
        <div className="bg-[#FDFAF5] rounded-2xl border border-[rgba(168,137,108,0.15)] shadow-sm p-3.5 mb-3">
          <div className="text-[13px] font-semibold text-[#5A5550] mb-3" style={{ fontFamily: 'Fredoka, sans-serif' }}>Productividad semanal</div>
          <div className="flex items-end gap-1.5 h-20">
            {barData.map((bar, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-1 h-full justify-end">
                ...
                <span className="text-[9px] text-[#8A847C] font-semibold">{bar.day}</span>
              </div>
            ))}
          </div>
          <div className="flex gap-2.5 mt-2.5 justify-center">
            <div className="flex items-center gap-1">
              ...
              <span className="text-[9px] text-[#8A847C]">Laboral</span>
            </div>
            <div className="flex items-center gap-1">
              <div className="w-2 h-2 rounded-sm bg-[#EDE6D8]"></div>
              <span className="text-[9px] text-[#8A847C]">Descanso</span>
            </div>
          </div>
        </div>
        ...
        {/* Donut chart */}
        <div className="bg-[#FDFAF5] rounded-2xl border border-[rgba(168,137,108,0.15)] shadow-sm p-3.5">
          <div className="text-[13px] font-semibold text-[#5A5550] mb-3" style={{ fontFamily: 'Fredoka, sans-serif' }}>Distribución de categorías</div>
            ...
            <div className="flex-1 space-y-1.5">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5">
                  <div className="w-2 h-2 rounded-sm bg-[#8FAF8A]"></div>
                  <span className="text-[11px] text-[#5A5550]">Estudio</span>
                </div>
                <span className="text-[11px] font-semibold text-[#5A5550]">50%</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5">
                  <div className="w-2 h-2 rounded-sm bg-[#7AADAA]"></div>
                  <span className="text-[11px] text-[#5A5550]">Proyectos</span>
                </div>
                <span className="text-[11px] font-semibold text-[#5A5550]">30%</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5">
                  <div className="w-2 h-2 rounded-sm bg-[#A89BC0]"></div>
                  <span className="text-[11px] text-[#5A5550]">Personal</span>
                </div>
                <span className="text-[11px] font-semibold text-[#5A5550]">20%</span>
              </div>
            </div>
          </div>
        </div>
